...
def append_update(lesson_path: Path, status: str, evidence: str | None, next_review: str | None) -> None:
...
def main() -> int:
    ...
    append_update(lesson_path, args.status, args.evidence, args.next_review)
